...
#'
#' Reuslts are returned as a data frame specific to each product. For the varialbes
#' returned with each endpont see the appropriate section in the documentation.
#'
#' \itemize{
