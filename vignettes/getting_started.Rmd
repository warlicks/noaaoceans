...
In the example below we start by loading the **noaaoceans** package and our supporting packages **dplyr** and **ggplot2**. We use the `list_stations()` to return a data frame with metadata for each of NOAA's measurement stations. 
